//! Focused retail 12.0.0 combat-audio percent enum values.
...
#[test]
fn test_patch_12_0_0_combat_audio_percent_enum_values() {
    ...
    let result: String = env
        .eval(
            r#"
                ...
                local error_message = check_values("CombatAudioAlertPercentValues", {
                    Off = 0,
                    Every10Percent = 1,
                    Every20Percent = 2,
                    Every30Percent = 3,
                ...
                error_message = check_values("CombatAudioAlertPercentValuesMeta", {
                    MinValue = 0,
                    MaxValue = 5,
                    NumValues = 6,
                })
    ...
    assert_eq!(
        result, "ok",
        "retail 12.0.0 combat-audio percent enum mismatch: {result}"
    );
}
