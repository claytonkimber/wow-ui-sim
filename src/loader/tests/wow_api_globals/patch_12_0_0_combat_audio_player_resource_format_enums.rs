//! Focused retail 12.0.0 combat-audio player-resource format enum values.
...
#[test]
fn test_patch_12_0_0_combat_audio_player_resource_format_enum_values() {
    ...
    let result: String = env
        .eval(
            r#"
                ...
                local error_message = check_values("CombatAudioAlertPlayerResourceFormatValues", {
                    ResourceFull = 0,
                    ResourceNoPercent = 1,
                ...
                error_message = check_values("CombatAudioAlertPlayerResourceFormatValuesMeta", {
                    MinValue = 0,
                    MaxValue = 5,
                    NumValues = 6,
                })
    ...
    assert_eq!(
        result, "ok",
        "retail 12.0.0 combat-audio player-resource format enum mismatch: {result}"
    );
}
