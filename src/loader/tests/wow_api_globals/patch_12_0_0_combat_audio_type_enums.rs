//! Focused retail 12.0.0 combat-audio type enum values.
...
#[test]
fn test_patch_12_0_0_combat_audio_type_enum_values() {
    ...
    let result: String = env
        .eval(
            r#"
                ...
                local error_message = check_values("CombatAudioAlertType", {
                    Health = 0,
                    Cast = 1,
                })
                ...
                error_message = check_values("CombatAudioAlertTypeMeta", {
                    MinValue = 0,
                    MaxValue = 1,
                    NumValues = 2,
                })
    ...
    assert_eq!(
        result, "ok",
        "retail 12.0.0 combat-audio type enum mismatch: {result}"
    );
}
