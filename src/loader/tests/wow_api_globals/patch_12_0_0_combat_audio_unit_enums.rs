//! Focused retail 12.0.0 combat-audio unit enum values.
...
#[test]
fn test_patch_12_0_0_combat_audio_unit_enum_values() {
    ...
    let result: String = env
        .eval(
            r#"
                ...
                local error_message = check_values("CombatAudioAlertUnit", {
                    Player = 0,
                    Target = 1,
                })
                ...
                error_message = check_values("CombatAudioAlertUnitMeta", {
                    MinValue = 0,
                    MaxValue = 1,
                    NumValues = 2,
                })
    ...
    assert_eq!(
        result, "ok",
        "retail 12.0.0 combat-audio unit enum mismatch: {result}"
    );
}
