//! Focused retail 12.0.0 crafting-order item-flag enum values.
...
#[test]
fn test_patch_12_0_0_crafting_order_item_flags_enum_values() {
    ...
    let result: String = env
        .eval(
            r#"
                ...
                local error_message = check_values("CraftingOrderItemFlags", {
                    None = 0,
                    NpcProvided = 1,
                ...
                error_message = check_values("CraftingOrderItemFlagsMeta", {
                    MinValue = 0,
                    MaxValue = 2,
                    NumValues = 3,
                })
    ...
    assert_eq!(
        result, "ok",
        "retail 12.0.0 crafting-order item-flag enum mismatch: {result}"
    );
}
